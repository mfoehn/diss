...
%-------------------------------------------------------------------------------------------------------
		...
		% First show the mass spectra and shortly say something about the noise, then switch to the other graphic and talk about the optimisation capabilities.
		
		% FS flight electronics signal degradation under the same paramter set (voltage and currents). -> optimisation. Impact. Signal degration is no effect from the detector (mention that or leave it?)
		% specially good visible when looking at the difference when comparing cold an hot case.
		% Stability of voltages and currents: 1 %
		% Mechanical manufacturing precission: 0.1 % (0.01 in best case. 0.1 mm is very bad)
		% Signals not fully optimised. Barely time during the test campaigns

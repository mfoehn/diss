...
%---------------------------------------------------------------------------------------------------------
	\subsection{Density Enhancement \notes{finished}}\label{chap:expDensEntSlit}
	\begin{figure}[h!]
		\centering
...
%----------------------------------------------------------------------------------------
	\subsection{Shutter Performance Test \notes{finished}}\label{chap:expShutter}
...
%--------------------------------------------------------------------------------------------
	\subsection{Pulser \notes{finished}} \label{chap:ExpPulser}% May explain here again the different parameters and why they matter?
...
%---------------------------------------------------------------------------------------------	
	\subsection{Sensor performance tests}
		...
		\newpage
		\subsubsection{FS \notes{finished}}\label{chap:FSCalib}
		\textbf{Ion Storage}\\

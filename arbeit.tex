...
%----------------------------------------------------------------------------------
	...
	% From here Formating is finished if the rest on top matches.
	\section*{Acknowledgement}
	
	% Try to setup something like that to have a reason to keep the rest short.
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width= .7\textwidth]{Team_Pic.jpg}

...
%----------------------------------------------------------------------------------
	...
	\begin{tabular}{>{\bfseries}l|l|>{\bfseries}l|l} % Formatierung!!!

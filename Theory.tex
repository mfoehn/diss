...
%-------------------------------------------------------------------------------------------		
		\subsubsection{Field-of-View Analysis \notes{finished}}\label{subsubsec:Calfly}
		\begin{figure}[h!]
			\centering
...
%		\textcolor{red}{see also density enhancement book for that derivation!!!}
		...
		\subsubsection{Detector Parameters \notes{Draft}} % Clean up this chapter when finalizing the detector chapter. Finalize the theory part and the explanation of the workmanship of the detector housing.

...
\usepackage[font=scriptsize,labelfont=bf]{caption} % setzten der Schriftgrösse von caption
\usepackage[font=scriptsize,labelfont=bf]{subcaption} % setzten der Schriftgrösse von subcaption
\usepackage{textgreek}
\usepackage{etoolbox}
\AtBeginEnvironment{tabular}{\footnotesize} % scriptsize or tiny (ist dann aber suuuuuper klein ;))
